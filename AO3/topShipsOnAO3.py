...
args = getArguments(
    sys.argv,
    2,
    "Usage: topShipsOnAO3 [min ship size] [outfile] (e.g.: topShipsOnAO3 1000 ships.csv)\n",
)
...
for r in ratingsTags:
    ...
    ships, fandoms = getTopShipsAndFandoms(
        r, [], excludeTags, minShipSize / len(ratingsTags), rShipsOut, rFandomsOut
    )
