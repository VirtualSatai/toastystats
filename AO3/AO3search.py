...
class AO3data:
    ...
    categories = {
        ...
        "category": {"num": 6, "top": {}},
        "fandom": {"num": 10, "top": {}},
        "character": {"num": 10, "top": {}},
        "relationship": {"num": 10, "top": {}},
        "freeform": {"num": 10, "top": {}},
    }
    htmlData = {}
    tagHtmlData = {}
    ...
    def createSearchURL(self):
        ...
        tmp = str(
            urlprefix + c + w + urlpredate + d + urlprequery + swr + urlpretag + t
        )
    ...
    def createUnsortedSearchURL(self):
        ...
        tmp = str(
            urlpredate + d + urlprefandom + fan + urlprefreeform + free + urlsuffix
        )
        self.searchURL = tmp.encode("utf-8")
